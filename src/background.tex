...
Peira is a framework for systematic conduct of experimental studies for the purpose of evaluating the appropriateness of conceptual modeling language vocabularies \cite{LZMK.24}. The method is based on having experimental participants classify samples of chunks of domain information to terms of a language, to which they have been previously trained and whose vocabulary is the subject of investigation vis-\`{a}-vis its quality. Peira offers a systematic approach to translate the resulting classification dataset into quality indicators.
...
Importantly, Peira accepts that quality indicators do not characterize the language absolutely, but relatively to a group of raters and the training the raters have received on the language. Hence, Peira evaluations aimed at assessing the quality of a language vis-\`{a}-vis a specific user population, require that raters are sampled from that population, or a population that can convincingly act as a proxy thereof.
