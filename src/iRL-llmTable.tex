\begin{table}[t]
\centering
\caption{\label{tab:llm_list}List of LLMs used for the study. Size in Bilions of parameters. For Mixture of Experts (MoE) \cite{SMMD+17} architectures, total available parameters are displayed.}
\centering
